...
{
    public sealed class TokamakEffect : StatusEffectTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(TokamakStatus);
        }
    ...
    public sealed class TokamakStatus : StatusEffect
    {
        ...
        private IEnumerable<BattleAction> OnOwnerTurnStarted(UnitEventArgs args)
        {
            ...
            NotifyActivating();
            yield return new ApplyStatusEffectAction<HeatStatus>(Battle.Player, base.Level, null, null, null, 0f, true);
