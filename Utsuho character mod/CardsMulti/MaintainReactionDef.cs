    ...
    public sealed class MaintainReactionDefinition : CardTemplate
    {
        ...
        public override CardConfig MakeConfig()
        {
            var cardConfig = new CardConfig(
                ...
                UpgradedRelativeKeyword: Keyword.Retain,

                RelativeEffects: new List<string>() { "MaintainReactionStatus" },
                UpgradedRelativeEffects: new List<string>() { "MaintainReactionStatus" },
